    ...
    <div class="container-fluid px-5 mybg-dark">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="card p-3">
                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="inputbox mt-3 me-3">
                                    <input type="text" name="name" class="form-control" required="required"> <span>Street Address</span> 
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="inputbox mt-3 me-3">
                ...
                <div class="mt-4 mb-4 d-flex justify-content-center "> <button class="btn buy_btn px-3">Pay $840</button> </div>
            </div>
