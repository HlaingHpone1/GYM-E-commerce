	...
	<div class="gallery_container py-5">
		<div class="product-grid">
			<div class="productcard stacked">
				<img src="img/bg.jpg" alt="a grey baseball hat with a small palm tree on the front" class="card__img" />
				<div class="card__content text-center">
					<h2 class="card__title">Lorem, ipsum dolor.</h2>
					<p class="card__price">$325</p>
					<p class="card__description">Lorem, ipsum dolor.</p>
					<a href="./productdetail.php" class="btn product_btn">Shop Now</a>
				</div>
			</div>
			...
			<div class="productcard stacked">
				<img src="img/bg1.jpg" alt="" class="card__img" />
				<div class="card__content text-center">
			...
			<div class="productcard stacked">
				<img src="img/bg2.jpg" alt="" class="card__img" />
				<div class="card__content">
					<!-- 30em 50em -->
					<h2 class="card__title text-center">Libero, ab dolorem?</h2>
			...
			<div class="productcard stacked">
				<img src="img/bg3.jpg" alt="" class="card__img" />
				<div class="card__content text-center">
			...
			<div class="productcard stacked">
				<img src="img/bg4.jpg" alt="" class="card__img" />
				<div class="card__content">
			...
			<div class="productcard stacked">
				<img src="img/bg5.jpg" alt="" class="card__img" />
				<div class="card__content text-center">
			...
			<div class="productcard stacked">
				<img src="img/bg6.jpg" alt="" class="card__img" />
				<div class="card__content text-center">
