	...
	<div class="container-fluid text-white mybg-dark">
		<div class="row policy">
			<div class="col-md-8 offset-md-2 ">
				<p class="policy_text my-5">At Crunch we respect your privacy. This privacy policy explains how Crunch, through its website or app, may collect, use, and share information about you. Since this policy may change over time as we modify or expand our services, we suggest that you check from time to time in order to understand how we treat your personal information. Your use of this website and its services constitute your agreement to Crunch using information about you in accordance with this privacy policy.</p>

				<div class="mb-5">
					<h2 class="fs-2">What Information Do We Collect? How Do We Use It?</h2>
					<p class="policy_text">When you purchase, we need to know your name, e-mail address, mailing address, credit card number, and expiration date. This allows us to process and fulfill your order and to notify you of your order status. When you enter a contest or other promotional feature, we may ask for your name, address, and e-mail address so we can administer the contest and notify winners.</p>
				</div>

				<div class="mb-5">
					<h2 class="fs-2">How Does Hge International, Llc Protect Customer Information?</h2>
					<p class="policy_text">We use a Secure Server for collecting personal and credit card information. The secure server layer (SSL) encrypts (scrambles) all of the information you enter before it is transmitted over the internet and sent to us. Furthermore, all of the customer data we collect is protected against unauthorized access.</p>
				</div>
				...
				<div class="mb-5">
					<h2 class="fs-2">How do we use your information?</h2>
					<p class="policy_text">
				...
				<div class="mb-5">
					<h2 class="fs-2">How do we use your email information?</h2>
					<p class="policy_text">
